...
struct queue {
    ...
    void (*func_free_page)(void *page,
                           void *privdata);  // the function to free a page
...
int queue_init(struct queue *queue, size_t entry_size, size_t page_size, void *(*func_alloc_page)(void *privdata),
               void (*func_free_page)(void *page, void *privdata), void *privdata);
