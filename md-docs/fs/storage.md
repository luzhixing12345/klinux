...
持久化存储并没有想象中的那么困难, 只要我们有一种方法可以改变物质的状态那么就可以持久化的存储信息. 三体中有一段非常有名的话:
...
> 这里需要注意, 这里的硬盘指的是磁盘, 不是现在的固态硬盘(SSD)

硬盘的机械结构如下:

![20240327201257](https://raw.githubusercontent.com/learner-lu/picbed/master/20240327201257.png)
...
> 关于硬盘结构的更多讨论见 device/disk, 这里不详细展开
...
U盘(USB + NAND flash), SD 卡, SSD **都是 NAND Flash**, 但软件/硬件系统的复杂程度不同,效率/寿命也不同. SSD 内部包含一个完整的操作系统, CPU DRAM NAND
...
> SSD 的设计十分复杂, 更多讨论见 device/ssd, 这里不详细展开
