...
大多数 Linux 发行版都遵循文件系统层次结构标准([Filesystem Hierarchy Standard](https://en.wikipedia.org/wiki/Filesystem_Hierarchy_Standard)), 并声明它自己的策略来维护 FHS 合规性 
...
- [FHS3.0 文档](https://refspecs.linuxfoundation.org/FHS_3.0/fhs-3.0.pdf)